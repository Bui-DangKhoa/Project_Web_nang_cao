            ...
            <div className="checkout-page">
                ...
                <div className="checkout-sidebar">
                    ...
                    <div className="sidebar-card">
                        ...
                        {discountAmount > 0 && (
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12, fontSize: 14, color: 'var(--green)' }}>
                                <span>Giảm giá</span>
                        ...
                        <div style={{ margin: '12px 0' }}>
                            ...
                            {couponMessage && (
                                <div style={{ marginTop: 8, fontSize: 12, color: discountAmount > 0 ? 'var(--green)' : 'var(--red)' }}>
                                    {couponMessage}
                                </div>
                            )}
                        </div>
